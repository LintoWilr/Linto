...
namespace Linto.LintoPvP.MNK.Triggers;

public class LintoPvPMNKQt : ITriggerAction
{
    ...
    public string DisplayName => "PvPMNK".Loc();

    public string Remark { get; set; }

    public bool Draw()
    {
        var qtArray = MNKQt.GetQtArray();
