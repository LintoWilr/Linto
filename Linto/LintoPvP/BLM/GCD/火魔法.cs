...
public class 火1 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 29649u, 25);
}
public class 火2 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 30896u, 25);
}
public class 火3 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 29650u, 25);
}
public class 火4 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 41473u, 25);
}
