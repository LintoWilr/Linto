...
public class 冰1 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 29653u, 25);
}
public class 冰2 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 30897u, 25);
}
public class 冰3 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 29654U, 25);
}
public class 冰4 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 41474U, 25);
}
