...
public class LB : ISlotResolver
{
    ...
    public void Build(Slot slot) => slot.Add(SpellHelper.GetSpell(29662u));
}
public class 异言 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 29658u, 25);
}
public class 耀星 : ISlotResolver
{
    ...
    public void Build(Slot slot) => PVPHelper.通用技能释放(slot, 41480u, 25);
}
