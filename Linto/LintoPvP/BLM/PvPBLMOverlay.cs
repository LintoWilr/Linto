...
public class PvPBLMOverlay
{
    ...
    public static class BLMQt
    {
        ...
        {
            return PvPBLMEntry.JobViewWindow.GetQt(qtName);
        }
        /// 反转指定qt的值
        /// <returns>成功返回true，否则返回false</returns>
        public static bool ReverseQt(string qtName)
        {
            return PvPBLMEntry.JobViewWindow.ReverseQt(qtName);
        }
        ...
        {
            return PvPBLMEntry.JobViewWindow.SetQt(qtName, qtValue);
        }

        /// 给指定qt设置新的默认值
        public static void NewDefault(string qtName, bool newDefault)
        {
            PvPBLMEntry.JobViewWindow.NewDefault(qtName, newDefault);
        }
        ...
        {
            PvPBLMEntry.JobViewWindow.SetDefaultFromNow();
        }

        /// 返回包含当前所有qt名字的数组
        public static string[] GetQtArray()
        {
            return PvPBLMEntry.JobViewWindow.GetQtArray();
        }
    }
}
