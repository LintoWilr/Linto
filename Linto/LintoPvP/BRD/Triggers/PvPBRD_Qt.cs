...
public class LintoPvPBRDQt : ITriggerAction
{
    ...
    public string DisplayName => "PvPBRD".Loc();

    public string Remark { get; set; }

    public bool Draw()
    {
        var qtArray = PvPBRDOverlay.BRDQt.GetQtArray();
    ...
    public bool Handle()
    {
        PvPBRDOverlay.BRDQt.SetQt(ValueName, Value);
        return true;
    }
