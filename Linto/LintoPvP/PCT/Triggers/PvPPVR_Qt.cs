...
public class LintoPvPPCTQt : ITriggerAction
{
    ...
    public string DisplayName => "PvPPCT".Loc();

public string Remark { get; set; } = string.Empty;

    public bool Draw()
    {
        var qtArray = PvPPCTOverlay.PCTQt.GetQtArray();
    ...
    public bool Handle()
    {
        PvPPCTOverlay.PCTQt.SetQt(ValueName, Value);
        return true;
    }
