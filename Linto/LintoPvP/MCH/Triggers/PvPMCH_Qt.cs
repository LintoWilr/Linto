...
public class LintoPvPMCHQt : ITriggerAction
{
    ...
    public string DisplayName => "PvPMCH".Loc();

    public string Remark { get; set; }

    public bool Draw()
    {
        var qtArray = PvPMCHOverlay.MCHQt.GetQtArray();
    ...
    public bool Handle()
    {
        PvPMCHOverlay.MCHQt.SetQt(ValueName, Value);
        return true;
    }
