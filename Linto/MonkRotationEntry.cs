...
public class MonkRotationEntry : IRotationEntry
{
  ...
  //  private IOpener opener90 = new OpenerWAR90();
    ...
    public List<ISlotResolver> SlotResolvers = new()
    {
        ...
        new MNKAbility_Mantra(),
        new MNKAbility_RiddleofEarth()
    };

    public string OverlayTitle { get; } = "Linto 日随专用盲僧";
