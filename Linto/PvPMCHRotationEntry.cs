...
public class PvPMCHRotationEntry : IRotationEntry
{
    ...
    public IRotationUI GetRotationUI() => new 监控UI代理(PvPMCHRotationEntry.JobViewWindow);
    private readonly PvPMCHSettingUI settingUI = new();
    public void OnDrawSetting() => settingUI.Draw();
    public static JobViewWindow JobViewWindow = null!;
    private readonly PvPMCHOverlay _lazyOverlay = new();
    ...
    public void BuildQt()
    {
        ...
        JobViewWindow.AddTab("职业配置", PvPMCHOverlay.DrawGeneral);
