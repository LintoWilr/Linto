...
public class PvPDRGRotationEntry : IRotationEntry
{
    ...
    public IRotationUI GetRotationUI() => new 监控UI代理(PvPDRGRotationEntry.JobViewWindow);
    private readonly PvPDRGSettingUI settingUI = new();
    public void OnDrawSetting() => settingUI.Draw();
    public static JobViewWindow JobViewWindow = null!;
    private readonly PvPDRGOverlay _lazyOverlay = new();
    ...
    public void BuildQt()
    {
        ...
        JobViewWindow.AddTab("职业配置", PvPDRGOverlay.DrawGeneral);
